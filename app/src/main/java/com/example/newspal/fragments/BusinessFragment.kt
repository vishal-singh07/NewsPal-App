...
class BusinessFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = NewsAdapter {
            this.findNavController().navigate(BusinessFragmentDirections.actionBusinessFragmentToFullNewsFragment(it))
        }
    ...
    private fun getTopHeadlines() {
        ...
        viewModel.getAllArticles(category = "business",country!!, this.requireContext().getString(R.string.api_key)).observe(this.viewLifecycleOwner) { articles ->
            articles.let {
