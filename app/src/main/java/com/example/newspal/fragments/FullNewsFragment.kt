...
import com.example.newspal.databinding.FragmentFullNewsBinding
...
class FullNewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (nightModeFlags == Configuration.UI_MODE_NIGHT_YES) {
            binding.saveBtn.setImageResource(R.drawable.ic_baseline_bookmark_border_light_24)
            binding.shareBtn.setImageResource(R.drawable.ic_baseline_share_light_24)
        }
        val article: Article = FullNewsFragmentArgs.fromBundle(requireArguments()).selectedNews
        ...
        binding.fullNewsBtn.setOnClickListener {
            this.findNavController().navigate(FullNewsFragmentDirections.actionFullNewsFragmentToWebViewFragment(article.url!!))
        }
