...
class HealthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = NewsAdapter {
            this.findNavController().navigate(HealthFragmentDirections.actionHealthFragmentToFullNewsFragment(it))
        }
    ...
    private fun getTopHeadlines() {
        ...
        viewModel.getAllArticles(category = "health",country!!, this.requireContext().getString(R.string.api_key)).observe(this.viewLifecycleOwner) { articles ->
            articles.let {
