...
class EntertainmentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = NewsAdapter {
            this.findNavController().navigate(EntertainmentFragmentDirections.actionEntertainmentFragmentToFullNewsFragment(it))
        }
    ...
    private fun getTopHeadlines() {
        ...
        viewModel.getAllArticles(category = "entertainment",country!!, this.requireContext().getString(R.string.api_key)).observe(this.viewLifecycleOwner) { articles ->
            articles.let {
